...
module pcihellocore_mm_interconnect_0 (
	...
	wire  [114:0] switches_s1_agent_rp_data;                                              // switches_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [114:0] led_red_s1_agent_rp_data;                                               // led_red_s1_agent:rp_data -> router_007:sink_data
	...
	wire          led_green_s1_agent_rp_valid;                                            // led_green_s1_agent:rp_valid -> router_008:sink_valid
	wire  [114:0] led_green_s1_agent_rp_data;                                             // led_green_s1_agent:rp_data -> router_008:sink_data
	wire          led_green_s1_agent_rp_ready;                                            // router_008:sink_ready -> led_green_s1_agent:rp_ready
	wire          led_green_s1_agent_rp_startofpacket;                                    // led_green_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          led_green_s1_agent_rp_endofpacket;                                      // led_green_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          router_005_src_valid;                                                   // router_005:src_valid -> switches_s1_rsp_width_adapter:in_valid
	wire  [114:0] router_005_src_data;                                                    // router_005:src_data -> switches_s1_rsp_width_adapter:in_data
	wire          router_005_src_ready;                                                   // switches_s1_rsp_width_adapter:in_ready -> router_005:src_ready
	wire    [8:0] router_005_src_channel;                                                 // router_005:src_channel -> switches_s1_rsp_width_adapter:in_channel
	wire          router_005_src_startofpacket;                                           // router_005:src_startofpacket -> switches_s1_rsp_width_adapter:in_startofpacket
	wire          router_005_src_endofpacket;                                             // router_005:src_endofpacket -> switches_s1_rsp_width_adapter:in_endofpacket
	wire          switches_s1_rsp_width_adapter_src_valid;                                // switches_s1_rsp_width_adapter:out_valid -> rsp_demux_004:sink_valid
	wire  [150:0] switches_s1_rsp_width_adapter_src_data;                                 // switches_s1_rsp_width_adapter:out_data -> rsp_demux_004:sink_data
	wire          switches_s1_rsp_width_adapter_src_ready;                                // rsp_demux_004:sink_ready -> switches_s1_rsp_width_adapter:out_ready
	wire    [8:0] switches_s1_rsp_width_adapter_src_channel;                              // switches_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	wire          switches_s1_rsp_width_adapter_src_startofpacket;                        // switches_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_004:sink_startofpacket
	wire          switches_s1_rsp_width_adapter_src_endofpacket;                          // switches_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_004:sink_endofpacket
	...
	wire  [114:0] router_007_src_data;                                                    // router_007:src_data -> led_red_s1_rsp_width_adapter:in_data
	wire          router_007_src_ready;                                                   // led_red_s1_rsp_width_adapter:in_ready -> router_007:src_ready
	wire    [8:0] router_007_src_channel;                                                 // router_007:src_channel -> led_red_s1_rsp_width_adapter:in_channel
	...
	wire  [150:0] led_red_s1_rsp_width_adapter_src_data;                                  // led_red_s1_rsp_width_adapter:out_data -> rsp_demux_006:sink_data
	wire          led_red_s1_rsp_width_adapter_src_ready;                                 // rsp_demux_006:sink_ready -> led_red_s1_rsp_width_adapter:out_ready
	wire    [8:0] led_red_s1_rsp_width_adapter_src_channel;                               // led_red_s1_rsp_width_adapter:out_channel -> rsp_demux_006:sink_channel
	...
	wire          router_008_src_valid;                                                   // router_008:src_valid -> led_green_s1_rsp_width_adapter:in_valid
	wire  [114:0] router_008_src_data;                                                    // router_008:src_data -> led_green_s1_rsp_width_adapter:in_data
	wire          router_008_src_ready;                                                   // led_green_s1_rsp_width_adapter:in_ready -> router_008:src_ready
	wire    [8:0] router_008_src_channel;                                                 // router_008:src_channel -> led_green_s1_rsp_width_adapter:in_channel
	wire          router_008_src_startofpacket;                                           // router_008:src_startofpacket -> led_green_s1_rsp_width_adapter:in_startofpacket
	wire          router_008_src_endofpacket;                                             // router_008:src_endofpacket -> led_green_s1_rsp_width_adapter:in_endofpacket
	wire          led_green_s1_rsp_width_adapter_src_valid;                               // led_green_s1_rsp_width_adapter:out_valid -> rsp_demux_007:sink_valid
	wire  [150:0] led_green_s1_rsp_width_adapter_src_data;                                // led_green_s1_rsp_width_adapter:out_data -> rsp_demux_007:sink_data
	wire          led_green_s1_rsp_width_adapter_src_ready;                               // rsp_demux_007:sink_ready -> led_green_s1_rsp_width_adapter:out_ready
	wire    [8:0] led_green_s1_rsp_width_adapter_src_channel;                             // led_green_s1_rsp_width_adapter:out_channel -> rsp_demux_007:sink_channel
	wire          led_green_s1_rsp_width_adapter_src_startofpacket;                       // led_green_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_007:sink_startofpacket
	wire          led_green_s1_rsp_width_adapter_src_endofpacket;                         // led_green_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_007:sink_endofpacket
	...
	wire          cmd_mux_004_src_valid;                                                  // cmd_mux_004:src_valid -> switches_s1_cmd_width_adapter:in_valid
	wire  [150:0] cmd_mux_004_src_data;                                                   // cmd_mux_004:src_data -> switches_s1_cmd_width_adapter:in_data
	wire          cmd_mux_004_src_ready;                                                  // switches_s1_cmd_width_adapter:in_ready -> cmd_mux_004:src_ready
	wire    [8:0] cmd_mux_004_src_channel;                                                // cmd_mux_004:src_channel -> switches_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_004_src_startofpacket;                                          // cmd_mux_004:src_startofpacket -> switches_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                            // cmd_mux_004:src_endofpacket -> switches_s1_cmd_width_adapter:in_endofpacket
	...
	wire  [150:0] cmd_mux_006_src_data;                                                   // cmd_mux_006:src_data -> led_red_s1_cmd_width_adapter:in_data
	wire          cmd_mux_006_src_ready;                                                  // led_red_s1_cmd_width_adapter:in_ready -> cmd_mux_006:src_ready
	wire    [8:0] cmd_mux_006_src_channel;                                                // cmd_mux_006:src_channel -> led_red_s1_cmd_width_adapter:in_channel
	...
	wire          cmd_mux_007_src_valid;                                                  // cmd_mux_007:src_valid -> led_green_s1_cmd_width_adapter:in_valid
	wire  [150:0] cmd_mux_007_src_data;                                                   // cmd_mux_007:src_data -> led_green_s1_cmd_width_adapter:in_data
	wire          cmd_mux_007_src_ready;                                                  // led_green_s1_cmd_width_adapter:in_ready -> cmd_mux_007:src_ready
	wire    [8:0] cmd_mux_007_src_channel;                                                // cmd_mux_007:src_channel -> led_green_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_007_src_startofpacket;                                          // cmd_mux_007:src_startofpacket -> led_green_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                            // cmd_mux_007:src_endofpacket -> led_green_s1_cmd_width_adapter:in_endofpacket
	...
	wire          led_green_s1_agent_rdata_fifo_src_valid;                                // led_green_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] led_green_s1_agent_rdata_fifo_src_data;                                 // led_green_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          led_green_s1_agent_rdata_fifo_src_ready;                                // avalon_st_adapter_007:in_0_ready -> led_green_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                      // avalon_st_adapter_007:out_0_valid -> led_green_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                       // avalon_st_adapter_007:out_0_data -> led_green_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                      // led_green_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                      // avalon_st_adapter_007:out_0_error -> led_green_s1_agent:rdata_fifo_sink_error
